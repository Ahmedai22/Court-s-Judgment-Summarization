...
class BartBaseLineFineTuned(pl.LightningModule):
    ...
    def add_model_specific_args(parent_parser):
      ...
      p.add_argument('-MaxSeqLen','--max_seq_length',type=int, default=1024)
...
"""class TrainDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        res = {"source_ids": source_ids, "source_mask": src_mask, "target_ids": target_ids, "target_mask": target_mask,
...
# custom class for mild sum dataset:
class TrainDataset(Dataset):
    def __init__(self, dataset, tokenizer, max_len=256, sample_size=1):
        self.sample_size = sample_size
        print("init TrainDataset ...")
...
# adding next class for mildsum dataset
